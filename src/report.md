...
![dump_P_5](./image/Part5/P_5_6_dump.png)
...
![dump_P_6](./image/Part6/P_6_1_11.png)
...
![r1](./image/Part7/P_7_0.png)
![ws22](./image/Part7/P_7_1.png)

##### Запустить веб-сервер Apache командой `service apache2 start` на ws22 и r1

-> `sudo service apache2 start`

![r1](./image/Part7/P_7_2.png)
![ws22](./image/Part7/P_7_3.png)
...
![r2](./image/Part7/P_7_4.png)

- `Запустить файл chmod +x /etc/firewall.sh и /etc/firewall.sh`

##### Проверить соединение между ws22 и r1 командой `ping`

![ws22](./image/Part7/P_7_5.png)
...
- `Добавил iptables -A FORWARD -p icmp ACCEPT`

##### Запускать файл также, как в Части 4

- `Запустить файл chmod +x /etc/firewall.sh и /etc/firewall.sh`

![r2](./image/Part7/P_7_6.png)

##### Проверить соединение между ws22 и r1 командой `ping`

![ws22](./image/Part7/P_7_7.png)

##### Добавить в файл ещё два правила:
##### 5) Включить **SNAT**, а именно маскирование всех локальных ip из локальной сети, находящейся за r2 (по обозначениям из Части 5 - сеть 10.20.0.0)
##### 6) Включить **DNAT** на 8080 порт машины r2 и добавить к веб-серверу Apache, запущенному на ws22, доступ извне сети

![r2](./image/Part7/P_7_8.png)

##### Проверить соединение по TCP для **SNAT**, для этого с ws22 подключиться к серверу Apache на r1 командой:
`telnet [адрес] [порт]`
##### Проверить соединение по TCP для **DNAT**, для этого с r1 подключиться к серверу Apache на ws22 командой `telnet` (обращаться по адресу r2 и порту 8080)

![ws22](./image/Part7/P_7_9.png)
![r1](./image/Part7/P_7_10.png)

##### Сохранить дампы образов виртуальных машин

![dump_P_7](./image/Part7/P_7_11.png)

## Part 8. Дополнительно. Знакомство с **SSH Tunnels**

##### Запустить на r2 фаервол с правилами из Части 7

![r2](./image/Part8/P_8_0.png)

##### Запустить веб-сервер **Apache** на ws22 только на localhost (то есть в файле */etc/apache2/ports.conf* изменить строку `Listen 80` на `Listen localhost:80`)

![ws22](./image/Part8/P_8_1.png)

##### Воспользоваться *Local TCP forwarding* с ws21 до ws22, чтобы получить доступ к веб-серверу на ws22 с ws21

![ws21](./image/Part8/P_8_2.png)

##### Воспользоваться *Remote TCP forwarding* c ws11 до ws22, чтобы получить доступ к веб-серверу на ws22 с ws11

![ws11](./image/Part8/P_8_3.png)

##### Для проверки, сработало ли подключение в обоих предыдущих пунктах, перейдите во второй терминал (например, клавишами Alt + F2) и выполните команду:
`telnet 127.0.0.1 [локальный порт]`

![ws11](./image/Part8/P_8_4.png)
![ws21](./image/Part8/P_8_5.png)

##### Сохранить дампы образов виртуальных машин

![dump_P_8](./image/Part8/P_8_6.png)